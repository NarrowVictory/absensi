...
<form action="proses edit kelas.php" method="post" enctype="multipart/form-data" style="max-width:100px; margin:auto">
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="text" id="id_kelas" name="id_kelas" placeholder="ID Kelas" value="<?php echo $id_kelas; ?>">
  </div></td></tr>
...
<tr>
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="text" id="nama" name="nama" placeholder="Nama Kelas" value="<?php echo $nama_kelas; ?>">
  </div></td></tr>
