...
<form action="proses edit guru.php" method="post" enctype="multipart/form-data" style="max-width:350px; margin:auto">
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="text" id="id" name="id" placeholder="ID Dosen" value="<?php echo $nip ?>">
  </div></td>

  <td>
  <div class="input-container">
    <i class="fas fa-user icon"></i>
    <input class="input-field" type="text" id="namalengkap" name="namalengkap" placeholder="Name" value="<?php echo $nama; ?>">
  </div></td></tr>
  
  <tr><td>
  <div class="input-container">
    <i class="far fa-calendar icon"></i>
    <input class="input-field" type="date" id="tanggallahir" name="tanggallahir" value="<?php echo $tgl; ?>">
  </div></td>

  <td>
  <div class="input-container">
    <i class="fas fa-envelope icon"></i>
    <input class="input-field" type="email" id="email" name="email" placeholder="E-mail" value="<?php echo $email; ?>">
  </div></td></tr>

  <tr><td>
  <div class="input-container">
    <i class="fas fa-users icon"></i>
    <input class="input-field" type="text" id="username" name="username" placeholder="Username" value="<?php echo $username; ?>" >
  </div></td>

  <td>
  <div class="input-container">
    <i class="fas fa-key icon"></i>
    <input class="input-field" type="password" id="password" name="password" placeholder="Password" value="<?php echo $password; ?>" readonly>
  </div></td></tr>
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="text" id="telepon" name="telepon" placeholder="Telephone" value="<?php echo $no_telp; ?>">
  </div></td>
