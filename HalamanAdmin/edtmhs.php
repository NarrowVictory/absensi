...
<form action="proses edit murid.php" method="post" enctype="multipart/form-data" style="max-width:350px; margin:auto">
  ...
  <div class="input-container">
    ...
    <select class="input-field" name="kelas" id="kelas" style="outline:0px; width: 100%; height: 39px; text-align: center; z-index: 999" >
                      <option selected="<?php echo $id_kelas ?>" style="margin-left: 8px; z-index: 999"><?php echo $id_kelas ?></option>
                      <?php
