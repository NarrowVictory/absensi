...
<div class="wrapper">
  ...
  <form role="form" action="lhtdosen.php" method="post" name="postform" enctype="multipart/form-data">
    
        <table border="0" style="display: inline; margin-left: 0;">
            <div ><tr><td>
              <a href="tmbdosen.php" target="_blank" style="color : white; text-decoration: none; margin-top: 10px;background-color: #f44336; padding: 10px 20px; border-radius: 5px;" href="" onmouseover="this.style.color='#0F0'" onmouseover="this.style.backgroundColor='#ffffff'" onmouseout="this.style.color='#ffffff'">Tambah Dosen</a></td>
              <input type="text" id="search" name="search" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;Masukan nama Dosen"/ style="border:none; width: 300px; height: 39px; border-radius: 5px; float: right;"> </tr>
            </div>
            </table>
...
?>  
          <tr>
            ...
            <td>    
            <a id="edit<?php echo $nip; ?>" href="edtdosen.php?id=<?php echo $nip; ?>">
              &nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-user-edit"></i>
            </a>                
               
            <a id="hapus<?php echo $nip; ?>" href="proses hapus guru.php?id=<?php echo $nip; ?>" onclick="return confirm('Anda yakin ingin menghapus?');">
