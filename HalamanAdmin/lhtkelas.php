...
<div class="wrapper">
  ...
  <form role="form" action="lhtkelas.php" method="post" name="postform" enctype="multipart/form-data">
    <table border="0" style="display: inline; margin-left: 0;">
            <div ><tr><td>
              <a href="tmbkelas.php" target="_blank" style="color : white; text-decoration: none; margin-top: 10px;background-color: #f44336; padding: 10px 20px; border-radius: 5px;" href="" onmouseover="this.style.color='#0F0'" onmouseover="this.style.backgroundColor='#ffffff'" onmouseout="this.style.color='#ffffff'">Tambah Kelas</a></td>
              <input type="text" id="search" name="search" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;Masukan nama Kelas"/ style="border:none; width: 300px; height: 39px; border-radius: 5px; float: right;"> </tr>
            </div>
            </table>
     ...
     if ( empty($_POST["search"]) ){
      ...
      $sql = "select *,g.nama_guru from kelas k join guru g on k.id_guru=g.id_guru where k.nama_kelas like '$cari%' order by nama_kelas"; 
          ...
          <tr>
            ...
            <td>
            <a id="edit<?php echo $id_kelas; ?>" href="edtkelas.php?id=<?php echo $id_kelas; ?>">
