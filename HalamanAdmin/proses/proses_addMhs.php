...
<?php
	...
	$nim= $_POST["nim"];
	$nama_murid1 = $_POST["namalengkap"];
	$nama_murid2 = $_POST["namalengkap"];
	$jk=$_POST["jk"];
	...
	if( $nim== "" || $nama_murid1 == ""  || $nama_murid2 == "" || $telp_ortu == "" || $nama_ortu == "" || $telp_ortu == ""  || $foto== "")
	{
		...
		$sql="insert into siswa values('$nim','$nama_murid1','$jk','$tgl_lahir','$alamat','$telepon','$nama_ortu','$telp_ortu','$kelas','$foto')";
		...
		echo '<META HTTP-EQUIV="Refresh" Content="0; URL=../tmbmhs.php">';
