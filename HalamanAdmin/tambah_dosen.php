  ...
  <div class="w3-container">
    ...
    <div class="w3-container">
                ...
                <tr>
                    ...
                    <td><input type="text" pattern="[P0-9]*" id="nip" name="nip" placeholder="Format : PXXX" /></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" pattern="[0-9]*" class="" id="telepon" name="telepon" /></td>
                </tr>
                ...
                <tr>
                <td><button type="submit">Tambah Dosen</button></td> 
                </tr>
                 </table> 
            </form>
    </div>
