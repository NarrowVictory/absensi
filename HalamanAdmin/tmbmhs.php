...
<form action="proses/proses_addMhs.php" method="post" enctype="multipart/form-data" style="max-width:350px; margin:auto">
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="text" id="nim" name="nim" placeholder="&nbsp;&nbsp;NIM">
  </div></td>

  <td>
  <div class="input-container">
    <i class="fas fa-user icon"></i>
    <input class="input-field" type="text" id="namalengkap" name="namalengkap" placeholder="&nbsp;&nbsp;Nama Lengkap">
  </div></td></tr>
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="text" id="alamat" name="alamat" placeholder="&nbsp;&nbsp;Alamat">
  </div></td>

  <td>
  <div class="input-container">
    <i class="fas fa-user-tie icon"></i>
    <input class="input-field" type="text" id="nama_ortu" name="nama_ortu" placeholder="&nbsp;&nbsp;Nama Ortu">
  </div></td></tr>

  <tr><td>
  <div class="input-container">
    <i class="fas fa-tty icon"></i>
    <input class="input-field" type="text" id="telp_ortu" name="telp_ortu" placeholder="&nbsp;&nbsp;Telp. Ortu">
  </div></td>

  <td>
  <div class="input-container">
    <i class="fas fa-phone-square-alt icon"></i>
    <input class="input-field" type="text" class="" id="no_telp" name="no_telp" placeholder="&nbsp;&nbsp;No. Telp (+62)">
  </div></td></tr>
  ...
  <div class="input-container">
    ...
    <select class="input-field" name="kelas" id="kelas" style="outline:0px; width: 100%; height: 39px; text-align: center; z-index: 999" >
                      <option disabled selected style="margin-left: 8px; z-index: 999">Pilih Kelas</option>
                      <?php
