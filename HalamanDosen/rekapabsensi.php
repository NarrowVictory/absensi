...
<div class="wrapper">
  ...
  <div class="main_container" style="margin-left: 270px;">
    ...
    <a href="rekapabsensiMK.php" target="_SELF" style="margin-top: 10px; float: right;" class="btn"> <i class="fas fa-angle-double-left"></i> &nbsp; Pilih Absensi per MK </a>

  <form action="rekapabsensi.php" method="post" name="postform">
